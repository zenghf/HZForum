...
<#include "header.ftl">
	...
	<div class="main w clearfix">
		<div class="main-left">
			<div class="share">
				<div class="share-left"><span></span>
                    ${tag!' All Topics'}
                </div>
			...
			<div class="post">
				<div class="post-wrap">
					<div class="post-choice">
						<a href="?${tidString}orderBy=time" class="${(order=='time')?then('post-choice-current','')}">Recent</a>
						<a href="?${tidString}orderBy=view" class="${(order=='view')?then('post-choice-current','')}">Hottest</a>
						<a href="?${tidString}orderBy=like" class="${(order=='like')?then('post-choice-current','')}">Most Liked</a>
                    ...
                    <nav class="col-md-10 col-md-offset-2">
                        <ul class="pagination pagination-sm">
                            <#--First Page-->
                            <li><a href="?${tidString}orderBy=${order}&curPage=1">First</a></li>
                            <#--Previous Page-->
                            <#if pageBean.curPage!=1>
                                <li><a href="?${tidString}orderBy=${order}&curPage=${pageBean.curPage-1 }"><span>&laquo;</span></a></li>
                            <#else>
                            ...
                            <#if pageBean.allPage lte 10>
                                <#list 1..pageBean.allPage as i>
                                    <li class="pageNum"><a href="?${tidString}orderBy=${order}&curPage=${i }">${i }</a></li>
                                </#list>
                            ...
                            <#if pageBean.curPage != pageBean.allPage>
                                <li><a href="?${tidString}orderBy=${order}&curPage=${pageBean.curPage+1 }"><span>&raquo;</span></a></li>
                            <#else>
                                <li><span>&raquo;</span></li>
                            </#if>

                            <#--Last Page    -->
                            <li><a href="?${tidString}orderBy=${order}&curPage=${pageBean.allPage}">Last</a></li>
                        </ul>
                    </nav>
